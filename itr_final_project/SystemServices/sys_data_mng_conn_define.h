...
#define SYS_DATA_MNG_CONN_ADC_TO_MNG  ((sys_data_mng_conn_t)0x00)
#define SYS_DATA_MNG_CONN_MNG_TO_UART ((sys_data_mng_conn_t)0x01)
#define SYS_DATA_MNG_CONN_UART_TO_MNG ((sys_data_mng_conn_t)0x02)
#define SYS_DATA_MNG_CONN_MNG_TO_LED  ((sys_data_mng_conn_t)0x03)
#define SYS_DATA_MNG_CONN_MNG_TO_BUZZ ((sys_data_mng_conn_t)0x04)
